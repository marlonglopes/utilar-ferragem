...
const NAV = [
  ...
  { to: '/admin/frete', label: 'Frete', short: 'Frete', icon: Truck },
  { to: '/admin/cupons', label: 'Cupons', short: 'Cupons', icon: Ticket },
  { to: '/admin/loja', label: 'Configuração da loja', short: 'Loja', icon: Store },
  { to: '/admin/cashback', label: 'Cashback', short: 'Cashback', icon: Coins },
  { to: '/admin/produtos', label: 'Produtos', short: 'Produtos', icon: Package },
  { to: '/admin/categorias', label: 'Categorias', short: 'Categorias', icon: Tags },
  { to: '/admin/importar', label: 'Importar produtos', short: 'Importar', icon: Upload },
  { to: '/admin/imagens', label: 'Imagens em lote', short: 'Imagens', icon: ImagePlus },
  { to: '/admin/avaliacoes', label: 'Avaliações', short: 'Avaliações', icon: Star },
