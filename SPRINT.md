...
| **8.5** | **Payment Hardening** — 5 críticas + 5 altas do [audit 2026-04-24](docs/security/payment-service-audit-2026-04-24.md) — **BLOQUEIA PROD** | 🚧 A iniciar após testes sandbox MP |
