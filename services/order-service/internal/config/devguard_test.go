...
func TestLoad_RecusaDevModeComBancoDeProducao(t *testing.T) {
	...
	t.Setenv("ORDER_DB_URL", "postgres://app:s3nh4@utilar-prod.abc.sa-east-1.rds.amazonaws.com:5432/db?sslmode=require")
...
func TestLoad_PermiteDevModeLocal(t *testing.T) {
	...
	t.Setenv("ORDER_DB_URL", "postgres://utilar:utilar@localhost:5432/db?sslmode=disable")
